      ...
      items: [
        {
          ...
          size: 'M',
          color: 'Gray',
          image: 'https://images.pexels.com/photos/7859406/pexels-photo-7859406.jpeg?auto=compress&cs=tinysrgb&w=400',
          quantity: 2,
          price: 39.99,
        },
      ],
              ...
              <div key={order.id} className="bg-white border border-gray-200 overflow-hidden">
                <div className="bg-gray-50 px-6 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-gray-200">
                  ...
                  <div className="flex items-center space-x-4">
                    <span
                      className={`px-4 py-1 text-sm font-semibold ${getStatusColor(order.status)}`}
                    >
                ...
                <div className="px-6 pb-6 flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                  ...
                  <button className="flex-1 border-2 border-gray-300 text-gray-700 py-3 font-semibold hover:bg-gray-100 transition-colors">
                    View Details
                  </button>
                </div>
              </div>
